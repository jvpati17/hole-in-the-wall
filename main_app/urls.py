...
urlpatterns = [
    ...
    path('reviews/create/<int:restaurant_id>/', views.ReviewCreate.as_view, name='review_create'),
    path('reviews/<int:pk>/update/', views.ReviewUpdate.as_view(), name='review_update'),
    path('restaurants/<int:pk>/delete_review/', views.ReviewDelete.as_view(), name='review_delete'),
